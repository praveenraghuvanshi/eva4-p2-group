...
def train_model(data_file):
    ...
    uploadedFileUrl = 'http://junk.com' #upload_to_s3(MODEL_FILE, MODEL_FILE)
...
def predict_sentiment(sentence, modelName, textFields):
    modelLocalFile = 'model.pt' #download_from_s3(modelName, modelName)
    textFieldsLocalFile = 'TEXT_fields.pkl' #download_from_s3(textFields, textFields)
