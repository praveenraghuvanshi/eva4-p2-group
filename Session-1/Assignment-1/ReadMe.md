...
<img src=".\rest-prediction.png" alt="Rest Client - Prediction" style="zoom:80%;" />



**Cloudwatch Logs**

<img src=".\cloudwatch-logs.png" alt="cloudwatch-logs" style="zoom:80%;" />
...
MODEL_PATH = os.environ['MODEL_FILE_NAME_KEY'] if 'MODEL_FILE_NAME_KEY' in os.environ else 'mobilenet_v2.pt'
...
provider:
  ...
  environment:
    ...
    MODEL_FILE_NAME_KEY: mobilenet_v2.pt
  iamRoleStatements:
    - Effect: "Allow"
      Action:
        - s3:getObject
